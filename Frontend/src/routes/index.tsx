...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "MeetWithStrangers — Chat with Strangers Worldwide | Free Random Chat | No Signup" },
      { name: "description", content: "MeetWithStrangers is the best free online chat platform to chat with strangers from 150+ countries. Random chat, language exchange, make friends online, and meet new people. Supports English, Hindi, Tamil, Malayalam, Telugu, Kannada, Bengali, Spanish, Japanese, Arabic & more. Real-time messaging, no signup, 100% private." },
      ...
      { property: "og:title", content: "MeetWithStrangers — Connect with Strangers Worldwide | Free & Private" },
      ...
      { name: "twitter:title", content: "MeetWithStrangers — Connect with Strangers Worldwide" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          author: { "@type": "Organization", name: "MeetWithStrangers" },
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-6 leading-relaxed">
          MeetWithStrangers is the best free online chat platform to <strong>chat with strangers</strong> from over 150 countries.
    ...
    <section id="features" className="px-6 py-24 md:py-32">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">MeetWithStrangers makes it easy to meet new people from anywhere in the world, instantly.</p>
        </div>
    ...
    <section className="px-6 py-24 md:py-32">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4">Connect across borders</h2>
          <p className="text-muted-foreground max-w-xl mx-auto mb-10">People from 150+ countries use MeetWithStrangers to chat with strangers, make friends online, practice languages, and explore new cultures through free random chat. Join the global community today.</p>
        {rows.map((row, i) => (
    ...
    <section className="px-6 py-24 md:py-32">
      <div className="max-w-3xl mx-auto text-center card-premium card-accent-top p-12 md:p-16">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto mb-8">
          Join thousands of people already chatting with strangers on MeetWithStrangers. The best free random chat and online chat platform. No signup, no download — just open your browser and start talking to strangers instantly. Make friends online, practice languages, and explore the world.
        </p>
...
function SEOSection() {
  const faqs = [
    { q: "What is MeetWithStrangers?", a: "MeetWithStrangers is a free online chat platform to chat with strangers from 150+ countries. It offers random chat, language exchange, and the ability to make friends online without any signup or download." },
    { q: "Is MeetWithStrangers free?", a: "Yes, MeetWithStrangers is 100% free. No hidden charges, no premium plans. You can chat with strangers online, make friends, and practice languages completely free." },
    ...
    { q: "What languages are supported?", a: "MeetWithStrangers supports 26+ languages including English, Hindi, Tamil, Malayalam, Telugu, Kannada, Bengali, Spanish, French, Japanese, Mandarin, Arabic, Portuguese, German, Korean, and more." },
    { q: "Is MeetWithStrangers safe for anonymous chat?", a: "Yes. We never store your data on our servers. Your profile stays on your device. No accounts, no tracking, no chat logs. The safest way to talk to strangers online." },
    { q: "Can I use MeetWithStrangers on mobile?", a: "MeetWithStrangers works on any device with a browser — phone, tablet, or desktop. No app download needed. Instant chat with strangers from anywhere." },
    { q: "MeetWithStrangers vs Omegle alternatives?", a: "MeetWithStrangers is the best Omegle alternative for free random chat with strangers. Unlike Omegle, we offer language filters, country filters, gender filters, and a global community of real people." },
  ];
  return (
    <section className="px-6 py-24 md:py-32 bg-gradient-to-b from-transparent via-[#7C3AED]/5 to-transparent">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">MeetWithStrangers is the best free random chat platform to meet new people online, make friends, and practice languages.</p>
        </div>
    ...
    <footer className="border-t border-border px-6 py-8">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold bg-gradient-to-r from-[#7C3AED] to-[#EC4899] bg-clip-text text-transparent">MeetWithStrangers</span>
        </div>
        <div className="flex items-center gap-6 text-xs text-muted-foreground">
          <span>© 2026 MeetWithStrangers — Chat with Strangers Worldwide</span>
